...
DUMMY_PROVIDERS = [
    {"id": "anthropic", "name": "Anthropic Claude", "desc": "Claude Sonnet / Opus / Haiku via API",
     "models": ["claude-sonnet-5", "claude-opus-4-8", "claude-haiku-4-5"], "requires_key": True,
     "status": "success", "active": True, "key_set": True},
    {"id": "openai", "name": "OpenAI", "desc": "GPT-4o / GPT-4o mini via API",
     "models": ["gpt-4o", "gpt-4o-mini", "gpt-4.1"], "requires_key": True,
     "status": "untested", "active": False, "key_set": False},
    {"id": "ollama", "name": "Ollama (Local)", "desc": "Run open models locally — no API key required",
     "models": ["llama3.1:8b", "mistral:7b", "phi3:mini"], "requires_key": False,
     "status": "success", "active": False, "key_set": True},
    {"id": "azure_openai", "name": "Azure OpenAI", "desc": "Enterprise-managed OpenAI models",
     "models": ["gpt-4o (azure)"], "requires_key": True,
     "status": "error", "active": False, "key_set": True},
]
...
class ProviderRow(Card):
    def __init__(self, provider: dict, group: QButtonGroup, on_select, on_test, on_key_changed,
        ...
        self.radio.setChecked(provider["active"])
        ...
        self.status_badge = StatusBadge(*reversed(CONN_META[provider["status"]]))
...
class LLMProvidersPage(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.update_providers(DUMMY_PROVIDERS)
