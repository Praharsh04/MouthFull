...
from ui.widgets.status_badge import StatusDot
...
class Toast(QWidget):
    def __init__(self, title: str, message: str, kind: str = "info", parent=None):
        ...
        icon.setStyleSheet(f"color: {color}; font-size: 16px; font-weight: 700;")
        ...
        close_btn.setStyleSheet("border: none; color: #888; font-size: 10px;")
