...
from ui.theme import Colors, APP_QSS
from ui.widgets import HotkeyRecorder, StatusBadge
...
class WelcomePage(WizardPage):
    def __init__(self, parent=None):
        super().__init__("🗣️", "Welcome to VoiceFlow AI",
...
class PermissionsPage(WizardPage):
    ...
    def __init__(self, parent=None):
        super().__init__("🔐", "Grant Permissions",
...
class HotkeyPage(WizardPage):
    ...
    def __init__(self, parent=None):
        super().__init__("⌨️", "Choose Your Hotkey",
...
class ModelSelectionPage(WizardPage):
    ...
    def __init__(self, parent=None):
        super().__init__("🎙️", "Choose a Speech Model",
