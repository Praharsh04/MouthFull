...
AVAILABLE_MODELS = [
    {"id": "tiny.en", "name": "Whisper Tiny (English)", "engine": "faster_whisper", "size": "75 MB",
     "lang": "English", "accuracy": "Basic", "speed": "Fastest"},
    {"id": "small.en", "name": "Whisper Small (English)", "engine": "faster_whisper", "size": "244 MB",
     "lang": "English", "accuracy": "Good", "speed": "Fast"},
    {"id": "medium.en", "name": "Whisper Medium (English)", "engine": "faster_whisper", "size": "769 MB",
     "lang": "English", "accuracy": "Very Good", "speed": "Moderate"},
    {"id": "large-v3", "name": "Whisper Large v3", "engine": "faster_whisper", "size": "2.9 GB",
     "lang": "Multilingual", "accuracy": "Excellent", "speed": "Slower"},
    {"id": "nvidia/parakeet-ctc-1.1b", "name": "Parakeet CTC 1.1B", "engine": "parakeet", "size": "1.1 GB",
     "lang": "English", "accuracy": "Excellent", "speed": "Fast (GPU)"},
]
...
class ModelRow(Card):
    def __init__(self, model: dict, on_install, on_remove, on_select, on_cancel, parent=None):
        ...
        self._status = model.get("status", "not_installed")
...
class ModelsPage(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Initial population will be done by UIBridge
        # self.update_models(AVAILABLE_MODELS)
