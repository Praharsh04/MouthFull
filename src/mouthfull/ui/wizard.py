...
from mouthfull.ui.theme import Colors, APP_QSS
from mouthfull.ui.widgets import HotkeyRecorder, StatusBadge
...
class WelcomePage(WizardPage):
    def __init__(self, parent=None):
        super().__init__("fa5s.comments", "Welcome to MouthFull AI",
...
class PermissionsPage(WizardPage):
    ...
    def __init__(self, parent=None):
        super().__init__("fa5s.lock", "Grant Permissions",
                          "MouthFull AI needs the following permissions to capture your voice and type on your behalf.",
                          parent)
        self.badges = {}
...
class FinishPage(WizardPage):
    def __init__(self, parent=None):
        super().__init__("fa5s.glass-cheers", "You're All Set!",
                          "MouthFull AI is ready to use. Try pressing your hotkey now, or open the dashboard "
...
class SetupWizard(QDialog):
    ...
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("MouthFull AI — Setup")
